...
let test = new Array(); // empty array
console.log(test);

let testTwo = new Array(3); // empty array with three items
console.log(testTwo);
...
/*
    - it's important to note that if you use the array constructor, and pass in a number, you are creating an array with an initial size. However, if you create an array with more than one argument, you create an array that holds those values.
*/
...
// TRADITIONAL FUNCTION (NOT ANONYMOUS)
// boardGames.forEach(function game() {
//     console.log(game);
// })
